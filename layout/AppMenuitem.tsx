...
const AppMenuitem = (props: AppMenuItemProps) => {
    ...
    useEffect(() => {
        ...
        const start = sessionStorage.getItem('startNavigationTime');
        const target = sessionStorage.getItem('targetRoute');

        if (start && target === pathname) {
            sessionStorage.removeItem('startNavigationTime');
    ...
    const itemClick = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
        ...
        if (item!.to) {
            sessionStorage.setItem('startNavigationTime', performance.now().toString());
            sessionStorage.setItem('targetRoute', item!.to);
        }
